...
parser.add_argument("model_type", choices=models,
                    type=types, help="Give model type.")
...
parser.add_argument("--alpha", type=float, default=0.,
                    help="What percentage of SNLI data to use in training")

parser.add_argument("--test", action='store_true',
                    help="Call if you want to only test on the best checkpoint.")

args = parser.parse_args()

'''
# Check if test sets are available. If not, create an empty file.
test_matched = "{}/multinli_1.0/multinli_1.0_test_matched_unlabeled.jsonl".format(
    args.datapath)

if os.path.isfile(test_matched):
    test_matched = "{}/multinli_1.0/multinli_1.0_test_matched_unlabeled.jsonl".format(
        args.datapath)
    test_mismatched = "{}/multinli_1.0/multinli_1.0_test_matched_unlabeled.jsonl".format(
        args.datapath)
